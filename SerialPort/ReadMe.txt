========================================================================
    ACTIVEX CONTROL DLL : SerialPort Project Overview
========================================================================

ControlWizard has created this project for your SerialPort ActiveX Control
...
that make up your SerialPort ActiveX Control DLL.
...
SerialPort.ico
    ...
    is included by the main resource file SerialPort.rc.

/////////////////////////////////////////////////////////////////////////////
CSerialPortCtrl control:

SerialPortCtrl.h
    This file contains the declaration of the CSerialPortCtrl C++ class.

SerialPortCtrl.cpp
    This file contains the implementation of the CSerialPortCtrl C++ class.

SerialPortPropPage.h
    This file contains the declaration of the CSerialPortPropPage C++ class.

SerialPortPropPage.cpp
    This file contains the implementation of the CSerialPortPropPage C++ class.

CSerialPortCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CSerialPortCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file SerialPort.rc.
...
stdafx.h, stdafx.cpp
    ...
    named SerialPort.pch and a precompiled types (PCT) file named stdafx.obj.
